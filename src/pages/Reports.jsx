    ...
    <div className="min-h-screen bg-[#131313] text-[#e5e2e1] flex flex-col font-inter">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div>
            <h1 className="text-2xl font-extrabold text-[#fafafa] tracking-tight uppercase font-geist">
              Laporan & Analytic
            </h1>
        ...
        {/* Filters Header */}
        <div className="bg-[#262626]/70 backdrop-blur-md border border-white/8 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08)] rounded-xl p-4 mb-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          {filterType === "custom" && (
            <div className="flex items-center gap-2 text-xs w-full md:w-auto font-mono">
              <input
                ...
                className="bg-[#0e0e0e] border border-white/8 text-white rounded-lg py-1.5 px-3 focus:outline-none focus:border-white/30"
              />
              <span className="text-[#a1a1a1]">s/d</span>
              <input
                type="date"
                value={endDate}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          <div className="bg-[#262626]/70 backdrop-blur-md border border-white/8 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08)] rounded-xl p-5">
            ...
            {activeTab === "checkins" ? (
              <table className="w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-white/5 text-[#e5e2e1]">
                  {loading ? (
                    <tr>
                      <td colSpan="5" className="px-6 py-8 text-center text-[#a1a1a1] text-xs font-mono">
                        Memuat data...
                      </td>
                    </tr>
              ...
              <table className="w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-white/5 text-[#e5e2e1]">
                  {loading ? (
                    <tr>
                      <td colSpan="6" className="px-6 py-8 text-center text-[#a1a1a1] text-xs font-mono">
                        Memuat data...
                      </td>
                    </tr>
